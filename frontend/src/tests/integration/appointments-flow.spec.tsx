  ...
  <div data-testid="book-appointment-page">
    ...
    <form data-testid="appointment-form">
      ...
      <div>
        ...
        <select id="time" data-testid="time-select">
    ...
    <div data-testid="form-error" style={{ display: 'none' }}></div>
  </div>
);
...
const Dashboard = () => (
  <div data-testid="dashboard">
    ...
    <button type="button" data-testid="appointments-link">
      My Appointments
    </button>
    <button type="button" data-testid="book-appointment-link">
      Book Appointment
    </button>
  </div>
);
